        ...
        if (mForecast == null) {
            ...
            DiffUtil.DiffResult result = DiffUtil.calculateDiff(new DiffUtil.Callback() {
                ...
                public boolean areContentsTheSame(int oldItemPosition, int newItemPosition) {
                    ...
                    ListWeatherEntry newWeatherEntry = newForecast.get(newItemPosition);
                    ListWeatherEntry oldWeatherEntry = mForecast.get(oldItemPosition);

                    return newWeatherEntry.getId() == oldWeatherEntry.getId()
                            && newWeatherEntry.getDate().equals(oldWeatherEntry.getDate());
                }
            });
            mForecast=newForecast;
